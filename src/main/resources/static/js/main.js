;(function () {
	...
	var imgClick = function() {
		$('#myModal-data').on('show.bs.modal', function (event) {
			...
			var contentOut = button.data('contentout');
			var modal = $(this);
			modal.find('#modalTitle').text(title);
			modal.find('#modalContentOut').text(contentOut);
		});
	};
	            	...
	            	type: 'post'
	            		...
	            		function(list) {
		                    ...
		                    for (var i = 0; i < list.length; i++) {
		                    	that.timePages.push({ title: list[i].title, contentOut: list[i].contentOut, timeMonth:list[i].timeMonth });
		                    }
